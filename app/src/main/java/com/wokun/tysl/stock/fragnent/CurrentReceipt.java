...
//当下进货单
public class CurrentReceipt extends SimpleRefreshAndLoadMoreFragment<MyOrderBean> {
...
//        });
        ...
        myOrderBean.setUserName("当前下单");
        myOrderBean.setUserPhone("1484531351");
        myOrderBean.setOrderState("1");
