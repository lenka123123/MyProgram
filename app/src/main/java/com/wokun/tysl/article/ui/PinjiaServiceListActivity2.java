...
//评价列表
public class PinjiaServiceListActivity2 extends SimpleRefreshAndLoadMoreActivity<EvalDataBean> {
    ...
    public BaseQuickAdapter<EvalDataBean, BaseViewHolder> initAdapter() {
        ...
        return new EvaAdapter2(R.layout.item_eval, null);
    }
    ...
    public Request initRequest() {
      ...
      //  int dietitianId = getIntent().getIntExtra(Constants.DIETITIAN_ID,0);
        return OkGo.<BaseResponse<ServiceBean>>post(Constants.BASE_URL + Constants.ARTICLE_RETAIL_EVAL_MORE)
                .tag(this).params("gid", gid);
    }
