...
//商品订单确认页面
public class GoodsOrderConfirmationActivity3 extends BaseBindingActivity {
...
/*    @BindView(R.id.recycler_view)
    ...
    public int createView() {
        return R.layout.activity_goods_order_confirmation2;
    }
    ...
    /*   mAdapter = new GoodsOrderConfirmationAdapter(R.layout.item_goods_order, null);
       ...
       //没有收货地址
        ...
        Intent intent = getIntent();
         Goods_ID = intent.getStringExtra(Constants.GOODS_ID);
    ...
    private void loadData() {
        Log.e("订单dd22", "//%%"+" Goods_ID222:"+Goods_ID);
                      ...
                      //  RxToast.showShort();
                       Log.e("订单2232",body.getMsg()+"");
                        ...
                        if (body.isState()) {
                            ...
                            Log.e("订单价格3", orderShow.getPayPrice()+"");
                            ...
                            Log.e("订单6", pay_price + "//" + orderShow.getDefaultAddress());
    ...
    private void doAlipay() {
        OkGo.<BaseResponse<Alipay>>post(Constants.BASE_URL + Constants.ORDER_SUBMIT_URL)
                ...
                .execute(new JsonCallback<BaseResponse<Alipay>>(Constants.WITH_TOKEN, Constants.ORDER_SUBMIT_URL) {
                    @Override
                    public void onSuccess(Response<BaseResponse<Alipay>> response) {//Alipay
                        BaseResponse body = response.body();
                        if (body == null) return;
                        if (body.isState()) {
                        ...
                        if (body.isState()) {
                          ...
                          //  new WXPay.Builder()
                            builder .setAppId(data.getAppid())
                                    ...
                                    .build()
                                    .toWXPayNotSign(GoodsOrderConfirmationActivity3.this);
                ...
                case SDK_PAY_FLAG: {
                   ...
                   PayResult payResult = new PayResult((Map<String, String>) msg.obj);
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        finish();
                        Log.e("进来了2","进来了2");
                    //    startActivity(ZhihuiSuccessfulActivity.class);
                    } else {
    ...
    protected void alipay(final String body) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(GoodsOrderConfirmationActivity3.this);
