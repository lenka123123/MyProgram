...
//商品订单待付款状态
public class GoodsOrderStateWaitPay extends SimpleRefreshAndLoadMoreFragment<GoodsOrderBean> {
    ...
    public Request initRequest() {
        ...
        return OkGo.<BaseResponse<OrderStateListResponse>>post(Constants.BASE_URL + Constants.ORDER_STATE_DATA_URL)
                .tag(this)
                .params(Constants.ORDER_STATE, 1);
    }
    ...
    public BaseQuickAdapter<GoodsOrderBean, BaseViewHolder> initAdapter() {
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if(R.id.action_immediate_payment == view.getId()){
                    GoodsOrderMgr.getInstance().onImmediatePayment(GoodsOrderStateWaitPay.this,bean);
                }else if(R.id.action_cancel_order == view.getId()){
                    GoodsOrderMgr.getInstance().onCancelOrder(GoodsOrderStateWaitPay.this,bean);
                }
            }
        });
