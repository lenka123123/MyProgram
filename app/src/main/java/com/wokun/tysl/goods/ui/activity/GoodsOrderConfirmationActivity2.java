...
//商品订单确认页面
public class GoodsOrderConfirmationActivity2 extends BaseBindingActivity {
...
/*    @BindView(R.id.recycler_view)
    ...
    /*   mAdapter = new GoodsOrderConfirmationAdapter(R.layout.item_goods_order, null);
       ...
       //没有收货地址
        ...
        ImageLoader.loadImage(goodsImage,goods_picture);
        goods_pay_price.setText(goodsPrice);
        goods_num.setText(1+"");
                    ...
                    public void onSuccess(Response<BaseResponse<WXPayResult>> response) {
                        ...
                        //    new WXPay.Builder()
                            ...
                            builder.setAppId(data.getAppid())
                                    ...
                                    .build()
                                    .toWXPayNotSign(GoodsOrderConfirmationActivity2.this);
    ...
    protected void alipay(final String body) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(GoodsOrderConfirmationActivity2.this);
