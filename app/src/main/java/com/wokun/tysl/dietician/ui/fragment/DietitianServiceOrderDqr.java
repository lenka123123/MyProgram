...
//待确认服务订单
public class DietitianServiceOrderDqr extends SimpleRefreshAndLoadMoreFragment<ServiceOrderBean> {
    ...
    public Request initRequest() {
        ...
        return OkGo.<BaseResponse<OrderListResponse>>post(Constants.BASE_URL + Constants.DIETITIAN_ORDER_LIST_URL)
                .tag(this)
                .params(Constants.ORDER_STATE, Constants.DQR)
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if(R.id.action_accept == view.getId()){ //同意服务
                    DieticianServiceOrderMgr.getInstance().onAccept(DietitianServiceOrderDqr.this,bean);
                }else if(R.id.action_refuse == view.getId()){//拒绝服务
                    DieticianServiceOrderMgr.getInstance().onRefuse(DietitianServiceOrderDqr.this,bean);
                }
            }
        });
