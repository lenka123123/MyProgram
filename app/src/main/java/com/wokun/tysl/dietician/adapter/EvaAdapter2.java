...
public class EvaAdapter2 extends BaseQuickAdapter<EvalDataBean, BaseViewHolder> {

    public EvaAdapter2(@LayoutRes int layoutResId, @Nullable List<EvalDataBean> data) {
    ...
    protected void convert(BaseViewHolder helper, EvalDataBean item) {
     //   ImageLoader.loadImage(item.getHeadImgUrl(), (ImageView) helper.getView(R.id.headimgurl));
        ImageLoader.loadImage(item.getAvatar(), (ImageView) helper.getView(R.id.headimgurl));
