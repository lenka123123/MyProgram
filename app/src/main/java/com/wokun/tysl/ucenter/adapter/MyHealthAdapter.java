...
public class MyHealthAdapter extends BaseQuickAdapter<UserServiceOrder,BaseViewHolder> {

    public MyHealthAdapter(@LayoutRes int layoutResId, @Nullable List<UserServiceOrder> data) {
