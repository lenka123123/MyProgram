...
public class HistoryKehuActivity extends BaseBindingActivity{
    @BindString(R.string.tysl_user_histotykehu)String title;
    ...
    public void init() {
        ...
        mRecyclerView.setAdapter(new MerchantAccountManagementAdapter3(R.layout.item_history_kehu,list));
