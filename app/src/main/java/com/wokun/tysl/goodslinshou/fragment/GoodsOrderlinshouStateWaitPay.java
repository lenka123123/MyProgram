...
//智慧商品待自提
public class GoodsOrderlinshouStateWaitPay extends SimpleRefreshAndLoadMoreFragment<GoodsZhihuibean> {
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if(R.id.action_immediate_payment == view.getId()){
                 //   GoodsOrderMgr.getInstance().onImmediatePayment(GoodsOrderlinshouStateWaitPay.this,bean);
                }else if(R.id.action_cancel_order == view.getId()){
                 //   GoodsOrderMgr.getInstance().onCancelOrder(GoodsOrderlinshouStateWaitPay.this,bean);
                }
            }
        });
