...
//智慧商品订单待评价
public class GoodsOrderlinshouStateWaitEvaluate extends SimpleRefreshAndLoadMoreFragment<GoodsZhihuibean> {
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if(R.id.action_evaluate == view.getId()){
                 //   GoodsOrderMgr.getInstance().onEvaluate(GoodsOrderlinshouStateWaitEvaluate.this,bean);
                }
            }
        });
