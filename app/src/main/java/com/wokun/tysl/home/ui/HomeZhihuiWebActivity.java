...
public class HomeZhihuiWebActivity extends BaseBindingActivity {
    @BindString(R.string.tysl_user_home_zhihui) String title;
    ...
    private void loadData() {
        ...
        String ids = intent.getStringExtra("zhihuilinshou");
